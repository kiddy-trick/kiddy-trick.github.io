...
function(a){for(var b=a.target;b&&b!=this;b=b.parentNode)if(b.matches("a")){C.call(b,a);break}},!1);f.addEventListener("click",function(a){for(var b=a.target;b&&b!=this;b=b.parentNode)if(b.matches("a")){C.call(b,a);break}},!1);t&&t.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();d.scrollIntoView(!0,{behavior:"smooth"})},!1);g();u();n=document.querySelector(".order");t=document.querySelectorAll(".return-to-cart");var z=document.querySelector(".cart-cart"),A=document.querySelector(".form-wrapper");
n.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();this.classList.contains("disabled")||(z.classList.add("hide"),A.classList.remove("hide"),A.classList.add("fade-in"))});n=$jscomp.makeIterator(t);for(t=n.next();!t.done;t=n.next())t.value.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();A.classList.add("hide");z.classList.remove("hide");z.classList.add("fade-in");a=this.parentNode;if(a.classList.contains("form-success")||a.classList.contains("form-error")){var b=
document.querySelector(".ajax-form");a.classList.add("hide");b.classList.remove("hide");b.classList.add("fade-in")}});(n=document.querySelector(".add-to-cart"))&&n.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();a=document.getElementById("product");a=JSON.parse(a.textContent);0==cartApi.totalCount()&&B();cartApi.addNewItemToCart(a.id,a.title,a.price,a.url,1);g();u();var b=this;b.innerHTML="\u0414\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u043e";window.setTimeout(function(){b.innerHTML=
"\u0412 \u043a\u043e\u0440\u0437\u0438\u043d\u0443"},2500,b)},!1);q.addEventListener("click",function(a){for(var b=a.target;b&&b!=this;b=b.parentNode)if(b.matches(".minus-item, .plus-item")){a.preventDefault();a.stopPropagation();var h=b.getAttribute("data");a=b.parentNode.querySelector("span");b.classList.contains("plus-item")?a.innerText=cartApi.addItemToCart(h):(h=cartApi.removeItemFromCart(h),0<h?a.innerText=h:(b=b.parentNode.parentNode.parentNode,b.parentNode.removeChild(b)));u();break}},!1);
document.querySelector(".ajax-form").addEventListener("submit",function(a){a.preventDefault();var b=this.parentNode.querySelector(".form-loading"),h=this.parentNode.querySelector(".form-success"),e=this.parentNode.querySelector(".form-error");a={name:this.elements.name.value,email:this.elements.email.value,message:this.elements.message.value,cart_sum:this.elements.cartstring.value,cart:cartApi.listCart()};this.classList.add("hide");b.classList.remove("hide");b.classList.add("fade-in");var p=new XMLHttpRequest;
p.open("POST","https://notstupidapp.ew.r.appspot.com/shopapi/kiddytrick");p.onload=function(){200<=this.status&&400>this.status?(console.log("Success"),console.log(this.responseText),b.classList.add("hide"),h.classList.remove("hide"),h.classList.add("fade-in"),cartApi.clearCart(),g(),u()):(console.log("Server returned error"),b.classList.add("hide"),e.classList.remove("hide"),e.classList.add("fade-in"))};p.onerror=function(){console.log("Connection error");b.classList.add("hide");e.classList.remove("hide");
e.classList.add("fade-in")};p.send(JSON.stringify(a))},!1)})();